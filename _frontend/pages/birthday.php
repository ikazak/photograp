...
<body>
    ...
    <header class="hero-section">
        <img src="<?=assets()?>/img/birthday.jpg"
...
Step into a world of laughter, joy, and unforgettable memories as you explore our birthday event photography gallery. At Cimmaroon Photography, we believe every birthday is a unique celebration deserving of creative and heartfelt documentation. Our clients have shown us how beautifully their special days can be captured, from intimate family gatherings to grand milestone parties.
    ...
    <div class="gallery-container">
        <div class="gallery-item">
            <img src="<?=assets()?>/img/day1.jpg" alt="Couple in a field at sunset">
        </div>
        <div class="gallery-item">
            <img src="<?=assets()?>/img/day2.jpg" alt="Woman in blue dress by water">
        </div>
        <div class="gallery-item">
            <img src="<?=assets()?>/img/day3.jpg" alt="Couple under an umbrella with smoke">
        </div>
        <div class="gallery-item">
            <img src="<?=assets()?>/img/day.jpg" alt="Couple sitting on a sofa indoors">
        </div>
        <div class="gallery-item">
            <img src="<?=assets()?>/img/day5.jpg" alt="Close-up of couple smiling">
        </div>
        <div class="gallery-item">
            <img src="<?=assets()?>/img/day6.jpg" alt="Couple standing in a garden">
        </div>
        <div class="gallery-item">
            <img src="<?=assets()?>/img/day7.jpg" alt="Couple in white formal wear">
        </div>
        <div class="gallery-item">
            <img src="<?=assets()?>/img/day8.jpg" alt="Close-up of a person's ear">
        </div>
        </div>
