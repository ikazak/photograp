    ...
    <div class="container content-section">
        ...
        <div class="row">
            <div class="col-lg-5 left-column">
                ...
                <div class="location-select-group p-4 rounded shadow-sm">
                    <p class="mb-3">Choose the location where your photoshoot will take place to check packages.</p>
                    <div class="mb-3">
                        <select class="form-select" aria-label="Location select">
                            <option selected>Sipalay City</option>
                        </select>
                    </div>
                </div>
            </div>
