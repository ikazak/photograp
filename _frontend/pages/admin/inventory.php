...
<head>
    ...
    <style>
        ...
        #myDataTable tbody td {
            color: #e9ecef !important; /* Light grey for body text for better readability than pure white */
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-dark text-center rounded p-4">
                ...
                <div class="table-responsive">
                    <table id="myDataTable" class="table table-dark table-striped table-bordered table-hover mb-0" style="width:100%;">
                        <thead>
                            <tr class="text-white">
                                <th>Image</th>
                                <th>Item Name</th>
