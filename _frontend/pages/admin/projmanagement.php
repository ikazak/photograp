...
<body>
            ...
            <div class="projects-page-container">
                ...
                <div class="projects-header">
                    ...
                    <div class="search-bar">
                        ...
                        <input type="text" class="form-control form-control-sm" placeholder="Search email or contact name" id="projectSearchInput">
                    </div>
                    <div class="actions">
                        <button class="btn btn-project-settings">Project Settings</button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const STAGES = [
            { id: 'inquiry', name: 'INQUIRY', color: 'var(--stage-inquiry)' },
            { id: 'booked', name: 'BOOKED', color: 'var(--stage-booked)' },
            { id: 'post-production', name: 'POST-PRODUCTION', color: 'var(--stage-post-production)' },
            { id: 'completed', name: 'COMPLETED', color: 'var(--stage-completed)' } // This will now use the red primary color
        ];
        ...
        let projects = [
            ...
            { id: 5, name: "Mmikaa's Project", client: "Mmikaa Asa", type: "Portrait", date: "", stage: "inquiry", details: "Initial contact made.", paid: 0 },
        ...
        function renderBoard() {
            ...
            STAGES.forEach(stage => {
                ...
                const projectsInStage = projects.filter(p => p.stage === stage.id && !p.archived);
        ...
        function renderListView() {
            ...
            activeProjects.forEach(project => {
                const stageInfo = getStageById(project.stage);
                const clientInitials = project.client.split(' ').map(n => n[0]).join('').toUpperCase().substring(0,2);
                ...
                row.innerHTML = `
                    ...
                    <td>${project.type || '-'}</td>
                    <td>
                        <span class="stage-badge" style="background-color: ${stageInfo.color};">${stageInfo.name}</span>
                    </td>
                    <td>${formatDate(project.date)}</td>
                    <td>₱${project.paid ? project.paid.toFixed(2) : '0.00'}</td>
                    <td>
                        <div class="dropdown">
